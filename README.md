## Motivation
Using Inversion of Control in frameworks such as [Laravel](https://laravel.com) make eveything about it feel so magical. However, some of the commands we're used to are not available in [Lumen](https://lumen.laravel.com/docs). This script reduces the need to manually go through that process especially as there are other important things to worry about when building your API.
